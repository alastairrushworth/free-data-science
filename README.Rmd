...
`r emo::ji('construction')` __This page is a work in progress!__
...
+ `r emo::ji('memo')` [__R Ladies Sydney: Basic Basics__ ](https://rladiessydney.org/courses/ryouwithme/01-basicbasics-0/).  Tour of RStudio, installing and using packages and getting data into RStudio.
...
https://kbroman.org/pkg_primer/
  + `r emo::ji('books')` [__Manuals__ by R-Core](https://cran.r-project.org/manuals.html)
...
+ `r emo::ji('bulb')` [__Pandas Cheat Sheet__](https://github.com/pandas-dev/pandas/blob/master/doc/cheatsheet/Pandas_Cheat_Sheet.pdf)
...
+ `r emo::ji('books')` [Python Data Science Handbook Jake VanderPlas](https://jakevdp.github.io/PythonDataScienceHandbook/)

## Shell

+ `r emo::ji('college')` [__Learn Shell__ ny](https://www.learnshell.org/)
...
# Developing interactive applications
  ...
  +`r emo::ji('books')` [__Dashboards__ by Yihui Xie, J. J. Allaire, Garrett Grolemund](https://bookdown.org/yihui/rmarkdown/dashboards.html) Chapter 5 from '_R Markdown: The Definitive Guide_'.
