...
+ `r emo::ji('books')` [__Introduction to Data Science: Data Analysis and Prediction Algorithms with R__ by Rafael A. Irizarry](https://rafalab.github.io/dsbook/).  
  + Introduction to data science focussed topics in R: visualisation, wrangling, prediction and workflow.
+ `r emo::ji('bulb')` [__Base R Cheat Sheet__ by  Mhairi McNeill](https://rstudio.com/wp-content/uploads/2016/10/r-cheat-sheet-3.pdf).  
...
+ `r emo::ji('college')` [__Learn Shell__ by Ron Reiter](https://www.learnshell.org/).  A browser-based interactive Shell tutorial covering basics through to advanced topics.
+ `r emo::ji('college')` [__The Unix Shell__ by Software Carpentry](http://swcarpentry.github.io/shell-novice/).  Tutorials and examples of how to use the unix shell.
+ `r emo::ji('memo')` [__Beginners/BashScripting__ by Ubuntu Documentation](https://help.ubuntu.com/community/Beginners/BashScripting).  Introduction to using the shell for OS navigation and scripting.
...
+ `r emo::ji('users')` [__R for Data Science Online Learning Community__](https://www.rfordatasci.com/). The R4DS Online Learning Community is a community of R learners at all skill levels working together to improve their skills.
+ `r emo::ji('users')` [__Tidy Tuesday__](https://www.tidytuesday.com/). A weekly podcast and community activity brought to you by the R4DS Online Learning Community.
+ `r emo::ji('users')`[__SatRdays__ SatRdays](https://satrdays.org/).  R-focused conferences that are held on Saturdays.
